...
te_vec, te_im, te_id, te_ohid1 = imload('test', 10000, 28, 28, 28, 28, 0)
...
def CNN_KF18kf2_RBF_AUG():
    ...
    s = tf.Variable(tf.constant([1.0, 1.0], tf.float32, [2]))
